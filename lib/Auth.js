...
/**
 * Get Google Login URL for direct browser redirect
 * @returns {string} The full backend URL to initiate Google OAuth
 */
...
/**
 * Get Google Account Linking URL for direct browser redirect
 * @returns {string} The full backend URL to initiate Google OAuth linking
 */
export function getGoogleLinkUrl() {
  return `${API_BASE_URL}/api/v1/auth/google/link`;
}
