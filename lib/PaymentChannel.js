 ...
 */
export async function registerPaymentChannel(data) {
 ...
 */
export async function updatePaymentChannel(pspId, data) {
 ...
 */
export async function deletePaymentChannel(pspId) {
  const res = await authenticatedFetch(`/api/v1/accounts/psp/${pspId}`, {
    method: "DELETE",
  });
