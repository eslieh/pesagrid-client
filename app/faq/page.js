...
export const metadata = {
  title: "Frequently Asked Questions | PesaGrid",
  description:
    "Find answers to common questions about PesaGrid's automated reconciliation platform. Learn how we automate M-PESA and bank matching for Kenyan businesses.",
  keywords: [
    "PesaGrid FAQ",
    "automated reconciliation Kenya",
    "M-PESA automation",
    "payment matching support",
    "fintech Kenya support",
    "business payments Kenya",
  ],
  openGraph: {
    title: "PesaGrid FAQ | Automated Reconciliation Support",
    description: "Got questions? We've got answers about PesaGrid's reconciliation platform built for Kenya.",
    url: "https://pesagrid.co.ke/faq",
    type: "website",
  },
};
    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mt-16 text-center">
          <div className="rounded-3xl border border-zinc-900/10 bg-white p-8 shadow-[0_1px_0_0_rgba(24,24,27,0.04),0_20px_60px_-40px_rgba(24,24,27,0.55)]">
